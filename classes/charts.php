...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("services" == $this->chrt_array['tables'][0])
			return true;
		if("doctors" == $this->chrt_array['tables'][0])
			return true;
		if("accounts" == $this->chrt_array['tables'][0])
			return true;
		if("appointments" == $this->chrt_array['tables'][0])
			return true;
		...
		if("products" == $this->chrt_array['tables'][0])
			return true;
		if("product_orders" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
