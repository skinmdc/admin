...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "id11524948_app1_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "accounts", "varname" => "id11524948_app1_at_localhost__accounts", "altvarname" => "accounts", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "appointments", "varname" => "id11524948_app1_at_localhost__appointments", "altvarname" => "appointments", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "doctors", "varname" => "id11524948_app1_at_localhost__doctors", "altvarname" => "doctors", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "product_orders", "varname" => "id11524948_app1_at_localhost__product_orders", "altvarname" => "product_orders", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "products", "varname" => "id11524948_app1_at_localhost__products", "altvarname" => "products", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "project2_audit", "varname" => "id11524948_app1_at_localhost__project2_audit", "altvarname" => "project2_audit", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "project2_settings", "varname" => "id11524948_app1_at_localhost__project2_settings", "altvarname" => "project2_settings", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "services", "varname" => "id11524948_app1_at_localhost__services", "altvarname" => "services", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "id11524948_app1_at_localhost__users", "altvarname" => "users", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
		}
	}
