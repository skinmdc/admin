...
function fillProjectEntites()
{
	...
	$projectEntities[ "doctors" ] = array( "url" => "doctors", "type" => 0 );
	$projectEntitiesReverse[ "doctors" ] = "doctors";
	$projectEntities[ "accounts" ] = array( "url" => "accounts", "type" => 0 );
	$projectEntitiesReverse[ "accounts" ] = "accounts";
	$projectEntities[ "appointments" ] = array( "url" => "appointments", "type" => 0 );
	$projectEntitiesReverse[ "appointments" ] = "appointments";
	$projectEntities[ "Administrator" ] = array( "url" => "administrator", "type" => 4 );
	$projectEntitiesReverse[ "administrator" ] = "Administrator";
	$projectEntities[ "New Customer" ] = array( "url" => "new_customer", "type" => 4 );
	$projectEntitiesReverse[ "new_customer" ] = "New Customer";
	$projectEntities[ "Scheduled Appointments" ] = array( "url" => "scheduled_appointments", "type" => 1 );
	$projectEntitiesReverse[ "scheduled_appointments" ] = "Scheduled Appointments";
	$projectEntities[ "Pending Appointments" ] = array( "url" => "pending_appointments", "type" => 1 );
	$projectEntitiesReverse[ "pending_appointments" ] = "Pending Appointments";
	$projectEntities[ "Cancelled Appointments" ] = array( "url" => "cancelled_appointments", "type" => 1 );
	$projectEntitiesReverse[ "cancelled_appointments" ] = "Cancelled Appointments";
	$projectEntities[ "Appointments / Reschedule" ] = array( "url" => "appointments___reschedule", "type" => 4 );
	$projectEntitiesReverse[ "appointments___reschedule" ] = "Appointments / Reschedule";
	$projectEntities[ "walkin" ] = array( "url" => "walkin", "type" => 1 );
	$projectEntitiesReverse[ "walkin" ] = "walkin";
	$projectEntities[ "new_walkin" ] = array( "url" => "new_walkin", "type" => 1 );
	$projectEntitiesReverse[ "new_walkin" ] = "new_walkin";
	$projectEntities[ "scheduled" ] = array( "url" => "scheduled", "type" => 1 );
	$projectEntitiesReverse[ "scheduled" ] = "scheduled";
	$projectEntities[ "products" ] = array( "url" => "products", "type" => 0 );
	$projectEntitiesReverse[ "products" ] = "products";
	$projectEntities[ "product_orders" ] = array( "url" => "product_orders", "type" => 0 );
	$projectEntitiesReverse[ "product_orders" ] = "product_orders";
}
