...
class ConnectionManager
{
	...
	{
		return $this->byId( "id11524948_app1_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "id11524948_app1_at_localhost";
		$data["connName"] = "id11524948_app1 at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;id11524948_app1;;1"; //currently unused

		$this->_connectionsIdByName["id11524948_app1 at localhost"] = "id11524948_app1_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "id11524948_app1";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=id11524948_app1;OPTION=3";
		// encription set
		...
		$connectionsData["id11524948_app1_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["users"] = "id11524948_app1_at_localhost";
		$connectionsIds["services"] = "id11524948_app1_at_localhost";
		$connectionsIds["doctors"] = "id11524948_app1_at_localhost";
		$connectionsIds["accounts"] = "id11524948_app1_at_localhost";
		$connectionsIds["appointments"] = "id11524948_app1_at_localhost";
		$connectionsIds["Scheduled Appointments"] = "id11524948_app1_at_localhost";
		$connectionsIds["Pending Appointments"] = "id11524948_app1_at_localhost";
		$connectionsIds["Cancelled Appointments"] = "id11524948_app1_at_localhost";
		$connectionsIds["walkin"] = "id11524948_app1_at_localhost";
		$connectionsIds["new_walkin"] = "id11524948_app1_at_localhost";
		$connectionsIds["scheduled"] = "id11524948_app1_at_localhost";
		$connectionsIds["products"] = "id11524948_app1_at_localhost";
		$connectionsIds["product_orders"] = "id11524948_app1_at_localhost";
