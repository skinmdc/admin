...
class tDAL
{
	var $tblid11524948_app1_at_localhost__accounts;
	var $tblid11524948_app1_at_localhost__appointments;
	var $tblid11524948_app1_at_localhost__doctors;
	var $tblid11524948_app1_at_localhost__product_orders;
	var $tblid11524948_app1_at_localhost__products;
	var $tblid11524948_app1_at_localhost__project2_audit;
	var $tblid11524948_app1_at_localhost__project2_settings;
	var $tblid11524948_app1_at_localhost__services;
	var $tblid11524948_app1_at_localhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "accounts", "varname" => "id11524948_app1_at_localhost__accounts", "altvarname" => "accounts", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
		$this->lstTables[] = array("name" => "appointments", "varname" => "id11524948_app1_at_localhost__appointments", "altvarname" => "appointments", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
		$this->lstTables[] = array("name" => "doctors", "varname" => "id11524948_app1_at_localhost__doctors", "altvarname" => "doctors", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
		$this->lstTables[] = array("name" => "product_orders", "varname" => "id11524948_app1_at_localhost__product_orders", "altvarname" => "product_orders", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
		$this->lstTables[] = array("name" => "products", "varname" => "id11524948_app1_at_localhost__products", "altvarname" => "products", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
		$this->lstTables[] = array("name" => "project2_audit", "varname" => "id11524948_app1_at_localhost__project2_audit", "altvarname" => "project2_audit", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
		$this->lstTables[] = array("name" => "project2_settings", "varname" => "id11524948_app1_at_localhost__project2_settings", "altvarname" => "project2_settings", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
		$this->lstTables[] = array("name" => "services", "varname" => "id11524948_app1_at_localhost__services", "altvarname" => "services", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "id11524948_app1_at_localhost__users", "altvarname" => "users", "connId" => "id11524948_app1_at_localhost", "schema" => "", "connName" => "id11524948_app1 at localhost");
	}
